...
Once the `conda-forge` channel has been enabled, `geant4-data-saiddata` can be installed with:

```
conda install geant4-data-saiddata
```

It is possible to list all of the versions of `geant4-data-saiddata` available on your platform with:
